      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-gray-500 italic">Haz doble clic sobre la imagen para recortarla</p>
          </div>
          <div 
            className="bg-gray-50 rounded-lg p-4 flex items-center justify-center min-h-[200px] cursor-pointer hover:bg-gray-100 transition-colors"
            onDoubleClick={onStartCropping}
          >
            <img
